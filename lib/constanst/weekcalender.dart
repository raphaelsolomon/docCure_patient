...
class CalendarWeek extends StatefulWidget {
  ...
  factory CalendarWeek(
          ...
          TextStyle dateStyle =
              const TextStyle(color: Colors.black, fontWeight: FontWeight.w400, fontSize: 13.0),
          TextStyle todayDateStyle = const TextStyle(
              color: Colors.white, fontWeight: FontWeight.w400, fontSize: 13.0),
          Color todayBackgroundColor = BLUECOLOR,
          Color pressedDateBackgroundColor = BLUECOLOR,
          TextStyle pressedDateStyle =
              const TextStyle(color: Colors.white, fontWeight: FontWeight.w400, fontSize: 13.0),
