...
List secondList = [
  ...
  {'title': 'Heart Rate Status', 'icon': 'assets/imgs/trend2.png', 'date': 'Last upload 2d', 'color': Color(0xFFffa69e)},
  {'title': 'FCB Status', 'icon': 'assets/imgs/bar.png', 'date': 'Last upload 5d', 'color': Color(0xFFa9d4ff)},
  {'title': 'Weight Status', 'icon': 'assets/imgs/search.png', 'date': 'Last upload 3d', 'color': Color(0xFFffb88e)},
];
...
List ONBOARDING = [
  {'image': 'assets/auth/spl.png', 'title': 'Instant Prescription', 'description': 'Get access to Doctors and Pharmacist if you are not sure of your prescription, you can easily chat and book online appointment with any Doctor of your Choice.'},
  {'image': 'assets/auth/panas.png', 'title': 'Book Appointments with Doctors Right from your Phone and System!', 'description': 'Get Access to a wide range of Specialist Doctors around the World have never been this easy.'},
  {
    'image': 'assets/auth/hospital.png',
  ...
  {'image': 'assets/auth/amico.png', 'title': 'Book Diagnostic Test from Experts Diagnostic Centers Globally!', 'description': 'You can have your Diagnostics Done on Schedule with our Wide network of Reliable Facilities and Centers.'},
  {
    'image': 'assets/auth/rafikis.png',
...
List<String> month = ['January', 'Febuary', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
...
getCustomFont({size = 14.0, color = Colors.black54, weight = FontWeight.w400, letterSpacing = 0.0}) {
  return GoogleFonts.poppins(fontSize: size, color: color, fontWeight: weight, letterSpacing: letterSpacing);
}
...
List shop_by_offer = [
  {'title': 'STAY HOME GET DISCOUNT', 'color': Colors.purpleAccent, 'icon': 'assets/estore/bro.png'},
  {'title': 'GET 50% OFF ON FIRST ORDER', 'color': Colors.amber, 'icon': 'assets/estore/bro.png'},
];

List allStores = [
  {'title': 'Wild Life Store', 'desc': 'Willington Bridge', 'color': Colors.lightGreen, 'icon': 'assets/estore/estore4.png'},
...
List<NavDrawerItem> getNavdraweritem_(BuildContext context) {
  return [
    NavDrawerItem(title: 'Home', icon: FontAwesome.home, children: [], isOpen: false, index: 0),
    NavDrawerItem(title: 'Dashboard', icon: FontAwesome5.dashcube, children: [], isOpen: false, index: 10),
    NavDrawerItem(title: 'My Vitals & Target', icon: FontAwesome.heart, children: [], isOpen: false, index: 1),
    NavDrawerItem(title: 'My Medical Records', icon: Icons.folder, children: [], isOpen: false, index: -10),
    NavDrawerItem(title: 'E-store', icon: FontAwesome5.store, children: [], isOpen: false, index: 4),
    NavDrawerItem(title: 'Doctor Booking', icon: FontAwesome5.user_nurse, children: [], isOpen: false, index: 3),
    // NavDrawerItem(
    ...
    //     isOpen: false,
    //     index: 4),
    NavDrawerItem(title: 'My Reminder', icon: Icons.alarm, children: [], isOpen: false, index: 8),
    NavDrawerItem(title: 'My Family', icon: Icons.family_restroom, children: [], isOpen: false, index: 7),
    NavDrawerItem(title: 'Profile Settings', icon: FontAwesome5.user, children: [], isOpen: false, index: -2),
    NavDrawerItem(
        title: 'Communication',
    ...
    NavDrawerItem(
        ...
        isOpen: false,
        index: -0),
    NavDrawerItem(title: 'Sign Out', icon: FontAwesome5.sign_out_alt, children: [], isOpen: false, index: 11),
  ];
}
...
List<Map<String, dynamic>> countryListDrop = [
  ...
  {"id": 10, "code": "1 268", "shortname": "ATG", "name": "Antigua and Barbuda"},
  ...
  {"id": 28, "code": "5997", "shortname": "BES", "name": "Bonaire, Sint Eustatius and Saba"},
  {"id": 29, "code": "387", "shortname": "BIH", "name": "Bosnia and Herzegovina"},
  ...
  {"id": 33, "code": "246", "shortname": "IOT", "name": "British Indian Ocean Territory"},
  ...
  {"id": 43, "code": "236", "shortname": "CAF", "name": "Central African Republic"},
  ...
  {"id": 48, "code": "61", "shortname": "CCK", "name": "Cocos (Keeling) Islands"},
  ...
  {"id": 51, "code": "242", "shortname": "COD", "name": "Congo, the Democratic Republic of the"},
  ...
  {"id": 64, "code": "1 809/829/ 849", "shortname": "DOM", "name": "Dominican Republic"},
  ...
  {"id": 72, "code": "500", "shortname": "FLK", "name": "Falkland Islands (Malvinas)"},
  ...
  {"id": 79, "code": "-", "shortname": "ATF", "name": "French Southern Territories"},
  ...
  {"id": 97, "code": "1 672", "shortname": "HMD", "name": "Heard Island and McDonald Islands"},
  {"id": 98, "code": "379", "shortname": "VAT", "name": "Holy See (Vatican City State)"},
  ...
  {"id": 105, "code": "98", "shortname": "IRN", "name": "Iran, Islamic Republic of"},
  ...
  {"id": 118, "code": "850", "shortname": "PRK", "name": "Korea, Democratic People's Republic of"},
  ...
  {"id": 122, "code": "856", "shortname": "LAO", "name": "Lao People's Democratic Republic"},
  ...
  {"id": 127, "code": "218", "shortname": "LBY", "name": "Libyan Arab Jamahiriya"},
  ...
  {"id": 132, "code": "389", "shortname": "MKD", "name": "Macedonia, the Former Yugoslav Republic of"},
  ...
  {"id": 145, "code": "691", "shortname": "FSM", "name": "Micronesia, Federated States of"},
  {"id": 146, "code": "373", "shortname": "MDA", "name": "Moldova, Republic of"},
  ...
  {"id": 165, "code": "1 670", "shortname": "MNP", "name": "Northern Mariana Islands"},
  ...
  {"id": 170, "code": "970", "shortname": "PSE", "name": "Palestinian Territory, Occupied"},
  ...
  {"id": 187, "code": "1 869", "shortname": "KNA", "name": "Saint Kitts and Nevis"},
  {"id": 188, "code": "1 758", "shortname": "LCA", "name": "Saint Lucia"},
  {"id": 189, "code": "590", "shortname": "MAF", "name": "Saint Martin (French part)"},
  {"id": 190, "code": "508", "shortname": "SPM", "name": "Saint Pierre and Miquelon"},
  {"id": 191, "code": "1 784", "shortname": "VCT", "name": "Saint Vincent and the Grenadines"},
  {"id": 192, "code": "685", "shortname": "WSM", "name": "Samoa"},
  {"id": 193, "code": "378", "shortname": "SMR", "name": "San Marino"},
  {"id": 194, "code": "239", "shortname": "STP", "name": "Sao Tome and Principe"},
  ...
  {"id": 201, "code": "1 721", "shortname": "SXM", "name": "Sint Maarten (Dutch part)"},
  ...
  {"id": 207, "code": "500", "shortname": "SGS", "name": "South Georgia and the South Sandwich Islands"},
  ...
  {"id": 213, "code": "47", "shortname": "SJM", "name": "Svalbard and Jan Mayen"},
  ...
  {"id": 217, "code": "963", "shortname": "SYR", "name": "Syrian Arab Republic"},
  {"id": 218, "code": "886", "shortname": "TWN", "name": "Taiwan, Province of China"},
  {"id": 219, "code": "992", "shortname": "TJK", "name": "Tajikistan"},
  {"id": 220, "code": "255", "shortname": "TZA", "name": "Tanzania, United Republic of"},
  ...
  {"id": 226, "code": "1 868", "shortname": "TTO", "name": "Trinidad and Tobago"},
  ...
  {"id": 230, "code": "1 649", "shortname": "TCA", "name": "Turks and Caicos Islands"},
  ...
  {"id": 234, "code": "971", "shortname": "ARE", "name": "United Arab Emirates"},
  {"id": 235, "code": "44", "shortname": "GBR", "name": "United Kingdom"},
  {"id": 237, "code": "1", "shortname": "USA", "name": "United States"},
  {"id": 236, "code": "1 808", "shortname": "UMI", "name": "United States Minor Outlying Islands"},
  ...
  {"id": 243, "code": "1 284", "shortname": "VGB", "name": "Virgin Islands, British"},
  {"id": 244, "code": "1 340", "shortname": "VIR", "name": "Virgin Islands, U.S."},
...
List<String> doctorsExperience = ['1-3 Years', '4–6 Years', '7–9 Years', '10–12 Years', '13-Years Above'];
...
List homeItem1 = [
  {'icon': 'assets/category/1.png', 'title': 'Find a Medical Center', 'desc': 'Find hospitals, laboratories, pharmacies and clinics'},
  {'icon': 'assets/category/2.png', 'title': 'Speak to a Doctor', 'desc': 'Discuss your health issues and book appointments'},
  {'icon': 'assets/category/3.png', 'title': 'Visit the ePharamcy', 'desc': 'Order medications and get it delivered anywhere'},
  {'icon': 'assets/category/4.png', 'title': 'Symptoms Checker', 'desc': 'Input symptoms and get instant diagnosis advice'},
];

List homeItem2 = [
  {'icon': 'assets/category/5.png', 'title': 'Book a Test', 'desc': 'Diagnostic tests at our partner laboratories'},
  {'icon': 'assets/category/6.png', 'title': 'Cementeries & Accessories', 'desc': 'Find cementeries and accessories'},
  {'icon': 'assets/category/7.png', 'title': 'Book an Ambulance', 'desc': 'Get closes ambulance for emergency'},
  {'icon': 'assets/category/8.png', 'title': 'Womens\'s Care', 'desc': 'Routine and Advanced care for all age'},
];
