            ...
            child: SingleChildScrollView(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                    ...
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(7.0), color: Colors.green.shade300),
                    child: Column(children: [
                      const SizedBox(height: 20.0),
                      Text(
                        '\$2,564.00',
                        style: GoogleFonts.lato(color: Colors.white, fontSize: 20.0, height: 1.4, fontWeight: FontWeight.w600),
                      ),
                      const SizedBox(height: 10.0),
                      Text(
                        'Available Balance',
                        style: GoogleFonts.lato(color: Colors.white, fontSize: 11.0, height: 1.4, fontWeight: FontWeight.w400, letterSpacing: 1.2),
                      ),
                      const SizedBox(height: 10.0),
                      Container(
                        padding: const EdgeInsets.symmetric(horizontal: 12.0, vertical: 5.0),
                        decoration: BoxDecoration(border: Border.all(width: 1.0, color: Colors.white), borderRadius: BorderRadius.circular(50.0)),
                        child: Text(
                          'Withdraw Full Amount'.toUpperCase(),
                          style: GoogleFonts.lato(color: Colors.white, fontSize: 11.0, height: 1.4, fontWeight: FontWeight.w500, letterSpacing: 1.2),
                        ),
                      ),
                      const SizedBox(height: 20.0),
                    ])),
                ...
                getDropDownAssurance('Withraw to'),
                const SizedBox(
                  height: 15.0,
                ),
                getCardForm('Enter Amount', '10,000,00', ctl: amountController, keyboardType: TextInputType.numberWithOptions(decimal: true), visible: true),
                const SizedBox(
                  height: 10.0,
                ),
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Flexible(
                          ...
                          child: Text(
                            'Amount to Withdraw',
                            style: GoogleFonts.lato(color: Colors.black, fontSize: 13.0, height: 1.4, fontWeight: FontWeight.w800, letterSpacing: 1.0),
                          )),
                      Text(
                        amount.isEmpty ? '0.00' : '${amount} USD',
                        style: GoogleFonts.lato(color: Colors.black, fontSize: 14.0, height: 1.4, fontWeight: FontWeight.w800),
                      ),
                      const SizedBox(width: 10.0)
                    ],
                  ),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      const SizedBox(height: 20.0),
                      Text('You are perform a withdrwal to', style: getCustomFont(size: 11.0, color: Colors.black54)),
                      const SizedBox(height: 10.0),
                      Text('To', style: getCustomFont(size: 11.0, color: Colors.black54)),
                      const SizedBox(height: 10.0),
                      Text('HDFC Bank - XXXXXXXXXXXXXXX-3245', style: getCustomFont(size: 12.0, color: Colors.black54, weight: FontWeight.w700)),
                      const SizedBox(height: 20.0),
                    ],
                  ),
                ),
                ...
                Padding(
                  padding: const EdgeInsets.symmetric(horizontal: 8.0),
                  child: Text('Details', style: getCustomFont(size: 13.0, color: Colors.black87, weight: FontWeight.w600)),
                ),
                const SizedBox(height: 10.0),
                Divider(),
                const SizedBox(height: 10.0),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Amount to withdraw ', style: getCustomFont(size: 13.0, color: Colors.black54)),
                    Text('1,000.00 USD', style: getCustomFont(size: 13.0, color: Colors.black54, weight: FontWeight.w700)),
                  ],
                ),
                const SizedBox(height: 10.0),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Fees: ', style: getCustomFont(size: 13.0, color: Colors.black54)),
                    Text('0.00 USD', style: getCustomFont(size: 13.0, color: Colors.black54, weight: FontWeight.w700)),
                  ],
                ),
                const SizedBox(height: 10.0),
                Divider(),
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    Text('Total: ', style: getCustomFont(size: 13.0, color: Colors.black54, weight: FontWeight.w700)),
                    Text('1,000.00 USD', style: getCustomFont(size: 13.0, color: Colors.black54, weight: FontWeight.w700)),
                  ],
                ),
                const SizedBox(height: 20.0),
            ...
            child: Column(
              children: [
                ...
                Padding(
                  ...
                  child: getButton(context, () => setState(() => currentStep = 1), text: 'Withdraw Money Again'),
                ),
                const SizedBox(height: 20.0),
                Row(
                  children: [
