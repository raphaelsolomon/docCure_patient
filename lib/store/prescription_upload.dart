          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text('Upload Prescription', style: getCustomFont(size: 17.0, color: Colors.white)),
                Icon(
                  null,
                  color: Colors.white,
                )
          ...
          child: Column(
            children: [
              GestureDetector(
                  ...
                  child: createPrescriptionButton(context, FontAwesome5.camera, 'Camera')),
              const SizedBox(
                height: 15.0,
              ),
              GestureDetector(
                  ...
                  child: createPrescriptionButton(context, FontAwesome5.file_import, 'From Gallery')),
              const SizedBox(
                height: 15.0,
              ),
              ...
              Text('Prescription Guide', style: getCustomFont(size: 17.0, color: Colors.black, weight: FontWeight.w500)),
              const SizedBox(
                height: 20.0,
              ),
              GestureDetector(onTap: () {}, child: createPrescriptionNote('Do not crop out any part of the prescription')),
              const SizedBox(
                height: 15.0,
              ),
