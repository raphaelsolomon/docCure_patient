  ...
  Widget build(BuildContext context) {
    return Column(children: [
      ...
      Expanded(child: Padding(
        ...
        child: Column(
         children: [
            createPrescriptionButton(FontAwesome5.camera, 'Camera'),
            const SizedBox(height: 15.0,),
             createPrescriptionButton(FontAwesome5.file_import, 'From Gallery'),
            const SizedBox(height: 15.0,),
             createPrescriptionButton(Icons.file_copy, 'My Prescriptions'),
