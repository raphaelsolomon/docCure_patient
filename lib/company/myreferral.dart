          ...
          Container(
            ...
            child: Column(children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(onTap: () => context.read<HomeController>().onBackPress(), child: Icon(Icons.arrow_back_ios, size: 20.0, color: Colors.white)),
                  Text('My Referrals', style: getCustomFont(size: 16.0, color: Colors.white)),
                  Icon(
                    null,
                    color: Colors.white,
                  )
                  ...
                  SizedBox(
                    child: Align(
                      ...
                      child: Text(
                        ...
                        style: getCustomFont(size: 24.0, color: Colors.black87, weight: FontWeight.w700),
                      ),
                    ),
                  ),
                  const SizedBox(
