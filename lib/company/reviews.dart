  ...
  Widget build(BuildContext context) {
    return Container(
        ...
        child: Column(children: [
            ...
            child: Column(children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Text('Reviews', style: getCustomFont(size: 18.0, color: Colors.white)),
                  InkWell(
                    onTap: () {
          ...
          Expanded(child: ListView.builder(padding: const EdgeInsets.symmetric(horizontal: 0.0, vertical: 0.0), itemCount: 5, shrinkWrap: true, itemBuilder: (ctx, i) => getReviews(context)))
        ]));
  }
}
