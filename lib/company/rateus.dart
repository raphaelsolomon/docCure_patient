  ...
  getFormSubscribe({ctl}) => Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
              contentPadding: const EdgeInsets.symmetric(horizontal: 20.0, vertical: 5.0), hintText: 'write your experience here', hintStyle: getCustomFont(size: 16.0, color: Colors.black54), border: OutlineInputBorder(borderSide: BorderSide.none)),
        ),
      );
}
